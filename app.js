/* ============================================
   TIENDA LEÓN — app.js (ACTUALIZADO)
   Catálogo dinámico + carrito + checkout WhatsApp NORMAL
   ============================================ */
...
// Número de WhatsApp NORMAL de la tienda (Actualizado)
// Se mantiene el formato internacional para que el enlace funcione directo (52 = México).
...
document.getElementById("checkoutBtn").addEventListener("click", () => {
  ...
  // El enlace de WhatsApp se mantiene igual (wa.me) porque funciona para ambos tipos de cuenta.
  // El cambio principal es la variable WHATSAPP_NUMBER que ya actualizamos arriba.
